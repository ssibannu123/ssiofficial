import { autodesk, computer, cpp, gameDev, graphicDesigning, modeling, msOffice, typing, videoEditing, web } from "./filesAndLink";
  ...
  const servicesDataArray = [
        ...
        },
        {
            imgUrl: msOffice,
            name: "MS Office",
            desc: "Advanced features of Microsoft Word, Excel, and PowerPoint for office and business use.",
            duration: 2,
            price: 6000
        },
        {
